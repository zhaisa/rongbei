...
//		area.selectByValue("110111");
		...
		Select s4 = new Select(dr.findElement(By.name("Subsector")));

		s4.selectByValue("9、信息传输、软件和信息技术服务业");
		...
		dr.findElement(By.name("pgjie3")).sendKeys("120万");
