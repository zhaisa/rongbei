...
public class XiaoFeiDaiLuRu {
	public void luRu(){
       ...
       dr.findElement(By.id("username")).sendKeys("zsphtest");
       ...
       dr.findElement(By.id("province")).click();
		...
		dr.findElement(By.name("typed")).click();	
		 Select s2=new Select(dr.findElement(By.id("typed")));
		...
		Select s3=new Select(dr.findElement(By.id("marrystare")));
		 s3.selectByValue("未婚");
		...
		Select s4=new Select(dr.findElement(By.id("xuli")));
		 s4.selectByValue("博士");
		
		dr.findElement(By.name("regisd")).click();	
		Select s5=new Select(dr.findElement(By.id("regisd")));
		 s5.selectByValue("是");
		
		dr.findElement(By.name("chuzu")).click();	
		Select s6=new Select(dr.findElement(By.id("chuzu")));
