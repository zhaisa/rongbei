...
public class BuyXiaoBiao {
	public void testPlan(int lineNo) throws Exception {
		...
		dr.navigate().to(
				"http://testhf.irongbei.com/index/plist?type=0&status=1&income=0&cycle=0&condition=close&payment=0");
		...
		dr.navigate().to(
				"http://testhf.irongbei.com/UserCenter/confirm?program=7532&account=1000&uvId=0&key=1b812458c6f75577f99a9e211854587a");
