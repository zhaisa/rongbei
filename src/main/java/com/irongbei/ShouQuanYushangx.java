...
public void shouQuan(String phone) throws InterruptedException {
	...
	Thread.sleep(1000);
	dr.navigate().to("http://only.irongbei.com/UserCenter/index");
//	dr.findElement(By.xpath("/html/body/div[1]/div[3]/div/div/div/div[1]/div[2]/ul/li[5]/dt/a")).click();
//	dr.navigate().to("only.irongbei.com/UserCenter/autoauth");
...
//			System.out.println("输入的数据为：" + str1);
	dr.navigate().to("http://only.irongbei.com/UserCenter/autoauth");
...
//			Thread.sleep(4000);
//			dr.navigate().to("only.irongbei.com/JxAuthorization/jxAutoAssignAuthBackstagePlus");
...
//							dr.findElement(By.linkText("立即关闭")).click();
							Thread.sleep(2000);
							dr.navigate().to("http://only.irongbei.com/JxAuthorization/newJxTermsAuthPageReturl");
