...
public class AddUerCreditYushangx {
	public void addUserCredit(String userp, String credit) throws InterruptedException {
		...
		dr.navigate().to("http://irongbei20180911.irongbei.com/admin/Voucher/userVoucherImport");
//		Thread.sleep(1000);
//		dr.findElement(By.id("give")).click();
		...
		Thread.sleep(2000);
		dr.navigate().to("http://irongbei20180911.irongbei.com/admin/Voucher/checkUserVoucher");
