...
public class CreateZhiTouNew extends RBConfig {
	@Test
	@Parameters({"zq","mylengh","myyear","mymonth","myday","env"})
	public void createZhiTou(String zq, int mylengh, int myyear, int mymonth, int myday,String env) throws Exception {
		...
		dr.findElement(By.id("project_type_pop")).findElement(By.id("Check5")).click();
		...
		String user = "新直投-" + userunder;

		System.out.println(user);

		dr.navigate().to(url+"/admin/Project/editProject?pjType=newbid");
